...
public class SecondFragment extends Fragment implements AnimatedTransitionFragment {
    ...
    public void onViewCreated(@NonNull View view, @Nullable Bundle savedInstanceState) {
        ...
        actionButton.setOnClickListener(v -> ((AnimatedFragmentTransitionActivity) getActivity()).getRouter().exit());
